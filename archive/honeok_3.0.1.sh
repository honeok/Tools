    ...
    while true; do
        ...
        case $choice in
            ...
            33)
                ...
                [ ! -d /data/script ] && mkdir -p /data/script
                cd /data/script || { _red "进入目录/data/script失败"; return 1; }
                curl -fsSL -o "${useip}_backup.sh" "${github_proxy}raw.githubusercontent.com/honeok/shell/main/callscript/web_backup.sh"
        ...
        while true; do
            ...
            case $choice in
                1)
                    ...
                    wget -qO - "${github_proxy}raw.githubusercontent.com/honeok/shell/main/callscript/archive.key" | gpg --dearmor -o /usr/share/keyrings/xanmod-archive-keyring.gpg --yes
    ...
    case "$choice" in
        [Yy])
            ...
            if [ -f "${globle_script_dir}/TG-check-notify.sh" ]; then
                ...
                curl -fsSL -o "${globle_script_dir}/TG-check-notify.sh" "${github_proxy}raw.githubusercontent.com/honeok/shell/main/callscript/TG-check-notify.sh"
                # 计算文件哈希
            ...
            curl -fsSL -o "${globle_script_dir}/TG-SSH-check-notify.sh" "${github_proxy}raw.githubusercontent.com/honeok/shell/main/callscript/TG-SSH-check-notify.sh"
            # 计算文件哈希
